<template>
     <div class="flex-1 pl-8 pr-8"> 
              <h1 class="text-4xl text-center font-bold mb-10 ">Proyectos</h1>
              <div class="grid grid-cols-1 gap-8 mb-8">
                  <div class="col-span-2 rounded-lg relative overflow-hidden flex flex-col border-2 border-solid border-white ">
                      <div class='z-10 w-full h-[50%] flex justify-end items-start p-3'>
                        <div>
                          <a href="https://bebidas-tan.vercel.app/" target="_blank">
                      ...
                      <div class='z-10 w-full h-[50%] bg-gradient-to-t to-transparent from-gray-700 flex flex-col items-start justify-end p-3'>
                  ...
                  <div class="col-span-2 rounded-lg relative overflow-hidden flex flex-col border-2 border-solid border-white ">
                      <div class='z-10 w-full h-[50%] flex justify-end items-start p-3'>
                        <div>
                          <a href="https://proyecto-tienda-guitarra.vercel.app/" target="_blank">
                            <span class="material-symbols-outlined text-5xl"  >
                              navigate_next
                            </span>
                          </a>
                  ...
                  <div class="col-span-2 rounded-lg relative overflow-hidden flex flex-col border-2 border-solid border-white ">
                      <div class='z-10 w-full h-[50%] flex justify-end items-start p-3'>
                        <div>
                          <a href="https://pacientes-ten.vercel.app/" target="_blank">
                            <span class="material-symbols-outlined text-5xl"  >
                              navigate_next
                            </span>
                          </a>
                      ...
                      <div class='z-10 w-full h-[50%] bg-gradient-to-t to-transparent from-gray-700 flex flex-col items-start justify-end p-3'>
                        <h2 class='text-white font-bold text-2xl'>Seguimiento de Pacientes Veterinaria</h2>
